      ...
      translate(
        {
          ...
          message: 'One page found|{count} pages found',
        },
        { count },
      ),
    );
...
function SearchPageContent(): JSX.Element {
  ...
  return (
    <Layout title={useTitleFormatter(getTitle())}>
      <Head>
        {/*
      ...
      <header className="max-w-screen-2xl mx-auto px-4 mb-4">
        <h1 className="text-3xl font-bold mt-2">Wiki Search Results</h1>
        <p className="text-center">{getTitle()}</p>
      </header>

      <main className="w-full max-w-screen-2xl mx-auto flex-grow flex flex-col text-left px-4">
