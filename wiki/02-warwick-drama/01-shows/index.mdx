...
:::info
These page is more focused on explaining how the Warwick Drama show process works. For general info about shows, please
...
this pack/panel process. Other 'shows' are considered [hires](../tech-crew/shows-and-hires) and are generally a much
smaller process.
